...
(function () {
  ...
  if (blessingForm) {
    blessingForm.addEventListener('submit', function (e) {
      e.preventDefault();
      var nameInput = document.getElementById('blessingName');
      var textInput = document.getElementById('blessingText');
      var errName = document.getElementById('errBlessingName');
      var errText = document.getElementById('errBlessingText');
      ...
      if (!textVal) {
        ...
        if (textInput) textInput.classList.remove('is-invalid');
      }
